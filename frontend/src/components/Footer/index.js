    ...
    <div className="footer-container">
      <div className="upper-footer">
        ...
        <div className="f-contact-us">
          <h2>Contact Us</h2>
          <p>Your address or contact info goes here</p>
          <p>Mail : costumer_service@bl.com</p>
        ...
        <div className="f-follow-us">
          ...
          <div className="social-networks-icons">
            ...
            <svg
              className="f-soical-network-icons"
            ...
            <div className="social-networks-icons">
            <a href="https://www.google.com"><svg
              className="f-soical-network-icons"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
            >
           ...
           <div className="social-networks-icons">
            <a href="https://twitter.com/?lang=en"><svg
              className="f-soical-network-icons"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
            >
